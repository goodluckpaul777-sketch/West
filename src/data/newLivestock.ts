...
export const NEW_LIVESTOCK_DATA: StockFish[] = [
  ...
  { sn: "12", commonName: "Arowana (big)", scientificName: "Heterotis niloticus" },
  { sn: "13", commonName: "Arowana (medium)", scientificName: "Heterotis niloticus" },
  { sn: "14", commonName: "Arowana (small)", scientificName: "Heterotis niloticus" },
  { sn: "15", commonName: "Atya Shrimps (big)", scientificName: "Atya gabonensis" },
  ...
  { sn: "33", commonName: "Elephant Nose (big)", scientificName: "Gnathonemus petersii" },
  { sn: "34", commonName: "Elephant Nose (medium)", scientificName: "Gnathonemus petersii" },
  { sn: "35", commonName: "Elephant Nose (small)", scientificName: "Gnathonemus petersii" },
  ...
  { sn: "77", commonName: "Puffer (med.)", scientificName: "Tetradon Mbu" },
  { sn: "78", commonName: "Puffer (small)", scientificName: "Tetradon Mbu" },
  ...
  { sn: "82", commonName: "Rainbow Crab (big)", scientificName: "Cardiosoma armatum" },
